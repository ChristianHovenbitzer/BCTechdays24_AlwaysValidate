codeunit 50200 InfiniteLoopTests
{
    ...
    begin
        ...
        Table.Validate(StartDate, SecondFebruary); // 2024/02/02
    ...
    begin
        ...
        //[WHEN]
        Table.SetStartEndDate(SecondFebruary, FirstMarch);

        //[THEN] then no error thrown  
    end;

    var
        FirstJanuary, FirstFebruary, SecondFebruary, FirstMarch : Date;
